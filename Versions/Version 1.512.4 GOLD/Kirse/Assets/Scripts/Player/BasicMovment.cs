...
public class BasicMovment : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        gm = GameManager.gm;
        p0 = FindObjectOfType<Pits>();
        p1 = FindObjectOfType<Pits1>();
        p2 = FindObjectOfType<Pits2>();
        p3 = FindObjectOfType<Pits3>();
    }
    ...
    void Update()
    {
        ...
        if (Time.timeScale > 0)
        {
            ...
            if (p3.point3==true)
            {
                this.transform.position = telepoint[3].position;
                p3.point3 = false;
            }
            else if (p2.point2 == true)
            {
                this.transform.position = telepoint[2].position;
                p2.point2 = false;  
            }
            else if (p1.point1 == true)
            {
                this.transform.position = telepoint[1].position;
                p1.point1 = false;
            }
            else if (p0.point0 == true)
            {
                this.transform.position = telepoint[0].position;
                p0.point0 = false;
            }
